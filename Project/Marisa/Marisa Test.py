            ...
            if self.Lastspellcheak < 18:
                ...
                if self.Lastspellcheak > 4:
                    if self.Lastspellcheak < 11:
                        # Player
                        self.LastspellEffect.clip_draw(self.LastspellEframe1 * 261, 250, 260, 250, self.Player + 400,
                                                       self.All_Y - 10)
                        # Enemy
                        self.LastspellEffect.clip_draw(self.LastspellEframe1 * 261, 0, 260, 250, self.Enemy - 400,
                                                       self.All_Y)
